  ...
  dataRows = [
    {
      ...
      detailedPurpose:
        ' Your posts, comments, messages, hashtags, time of activity, frequency and duration of your activities.',
      dataCollected: 'User Data, Phone, Usage Data, Payment and Purchase Data',
    },
    {
      shortPurpose: 'For personalized advertisements',
      detailedPurpose:
        ' Your profile information, Your activity on and off Meta products, information that Facebook receive through cookies, things Facebook infer about you such as topics, information about your friends including their activity or interests.',
      dataCollected:
        'User Data, Survey and Research Data, Payment and Purchase Data',
    },
    {
      shortPurpose: 'Sharing information with third parties',
      detailedPurpose:
        ' Your device information, websites that you visit and cookie data, apps you use, games you play, purchases and transactions you make online, the ads you see and how you interact with them.',
      dataCollected: 'User Data, Purchases, Payment and Purchase Data',
    },
    {
      shortPurpose: 'Information from device settings',
      detailedPurpose:
        ' Your device and software you are using, signals from your device, and GPS locations. ',
      dataCollected: 'User Data, Locations, Survey and Research Data',
    },
    {
      shortPurpose: 'To communicate with you',
      detailedPurpose:
        ' Your contact information, your phone book, settings data and other information related to your friends and followers on Facebook. ',
