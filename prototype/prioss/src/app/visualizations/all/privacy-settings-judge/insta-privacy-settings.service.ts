  ...
  settings = [
    {
      ...
      howToCheck :"Please look <a  target='_blank' href=/insta/account-private><strong>here </a> </strong> for the picture guide to make Instagram account private.",
        options : [
    ...
    },
    {
      ...
      howToCheck : "Please look <a target='_blank' href=/insta/profile-info-private> <strong>here</a></strong> for the picture guide to make Instagram profile information private.",
      options : [
    ...
    },
    {
      ...
      howToCheck : "Please look <a target='_blank' href=/insta/two-factor-authentication> <strong> here </a></strong>for the picture guide to turn ON two-factor authentication for Instagram.",
      options : [
    ...
    },
    {
      ...
      howToCheck : "Please look <a target='_blank' href=/insta/add-manager> <strong> here </a></strong> for the picture guide to manage advertisements for your Instagram account.",
      options : [
    ...
    },
    {
      ...
      howToCheck : "Please look <a target='_blank' href=/insta/revoke-access> <strong> here </a></strong> for the picture guide to revoke access to third-party apps for your Instagram account. </a></strong> ",
      options : [
