...
import * as sql from "./face_who_you_follow.sql";


/**
 * This repository component is responsible for providing functions to insert and request data from the
 * face_who_you_follow table that holds all data regarding friends followed by the user.
 * 
 * @author: Deepa (dbelvi@mail.upb.de)
 */

@Injectable()
export class FacebookWhoYouFollowRepository extends BulkAddCapableRepository {
    constructor(dbService: DBService) {
        super(sql.bulkAddFaceWhoYouFollowBaseSQL, sql.bulkAddFaceWhoYouFollowValuesSQL, sql.bulkAddValueConnector, dbService);
    }
    ...
    /**
     * Adds a row to the Facebook face_who_you_follow table as part of a bulk-add run
     * 
     * @author: Deepa (dbelvi@mail.upb.de)
     */
